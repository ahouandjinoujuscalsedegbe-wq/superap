...
const MOTS_VIDES = new Set([
  ...
  "ou", "a", "est", "sont", "je", "tu", "il", "on", "me", "te", "se", "mon",
  "ma", "mes", "ton", "ta", "tes", "ce", "cet", "cette", "que", "qui", "quoi",
  "dans", "sur", "pour", "avec", "sans", "plus", "moins", "tres", "bien",
  "combien", "quel", "quelle", "quels", "quelles", "comment", "pourquoi",
  "fais", "dis", "moi", "ca", "y", "il y a", "as", "ai", "es", "avons",
  "peux", "peut", "veux", "veut", "savoir", "voir", "donne", "donner",
]);
