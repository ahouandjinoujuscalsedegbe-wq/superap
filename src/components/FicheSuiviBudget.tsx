...
/**
 * Suivi du mois : budget mensuel automatique de chaque enveloppe comparé aux
 * dépenses réellement enregistrées. Calcul entièrement local.
 */
export function FicheSuiviBudget() {
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        Budget calculé seul depuis la période de renouvellement de chaque enveloppe, puis comparé
