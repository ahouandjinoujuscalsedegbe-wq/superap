    ...
    <div className="space-y-5">
      ...
      <section className="carte space-y-2 p-4">
        ...
        <p className="text-sm text-muted-foreground">
          Déjà disponibles : comptes et transferts, enveloppes classées par catégorie, budgétisation
          avec conversion automatique des échéances, dettes et créances avec impact sur les comptes,
